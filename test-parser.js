...
console.log("Testing MeetPro Parser:\n");
...
testLines.forEach(line => {
    ...
    if (result) {
        ...
        console.log(`    Place: ${result.place}, Name: ${result.name}, Grade: ${result.grade || 'N/A'}`);
        console.log(`    Bib: ${result.bib}, Team: ${result.team}, Time: ${result.time}, Points: ${result.points || 'N/A'}`);
    } else {
        console.log(`  ✗ Failed to parse (correctly skipped)`);
    }
    console.log('');
});
